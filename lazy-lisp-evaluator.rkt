...
; procedure application is none of the above
...
; cond is a list of clauses
; a clause is made of a predicate and an action
...
(define (primitive-impl proc) (cadr proc))
...
(define primitive-procedures
  (list (list 'car car)
        ...
        (list 'null? null?)
        (list '+ +)
        (list '= =))) ; more primitive procedures
...
; thunks are represented as a list containing an expression
; and the environment
...
(define (apply-primitive-procedure procedure arguments)
  (apply-in-underlying-scheme (primitive-impl procedure) arguments))
